...
import controller.Forecasting_Controller;
 ...
 * @author EACMS
 */
public class Weighted_moving_average extends javax.swing.JFrame {

    String[] months = new String[3];
    double[] months_sales = new double[3];

    /**
     * Creates new form Weighted_moving_average
     */
    public Weighted_moving_average() {
        initComponents();
        loadingProductID();
    ...
    private void initComponents() {
        ...
        s_w_field_1 = new javax.swing.JLabel();
        s_w_field_2 = new javax.swing.JLabel();
        s_w_field_3 = new javax.swing.JLabel();
        ...
        cancelBTN1.setText("Calculate WMA");
        ...
        Error_lable.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Error_lable.setForeground(new java.awt.Color(255, 51, 51));
        Error_lable.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        s_w_field_1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        s_w_field_1.setText(".");

        s_w_field_2.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        s_w_field_2.setText(".");

        s_w_field_3.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        s_w_field_3.setText(".");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(Error_lable, javax.swing.GroupLayout.PREFERRED_SIZE, 363, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(59, 59, 59)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(s_w_field_2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(weight_3_field, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(s_w_field_3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                    .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(s_w_field_1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(72, 72, 72)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(producIdCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 232, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(s_w_field_3))
                .addGap(27, 27, 27)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cancelBTN1)
                    .addComponent(Error_lable, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void loadingProductID() {
        this.sales.setText("");
        this.s_w_field_1.setText("");      
        this.s_w_field_2.setText("");
        this.s_w_field_3.setText("");
    ...
    private void cancelBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelBTNActionPerformed
        this.dispose();
        Forcasting_Home_screen forcasting_Home_screen = new Forcasting_Home_screen();

        forcasting_Home_screen.setVisible(true);
    ...
    private void cancelBTN1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelBTN1ActionPerformed
        ...
        if (this.weight_1_field.getText().equals("") || this.weight_2_field.getText().equals("") || this.weight_3_field.getText().equals("")) {
            ...
            try {
                ...
                this.Error_lable.setText("Enter valid values");
                calculate = false;
            }
            if (calculate) {
                ...
                if (w1 + w2 + w3 == 100) {
                    this.s_w_field_1.setText(String.valueOf(w1 * months_sales[0] / 100));
                    this.s_w_field_2.setText(String.valueOf(w2 * months_sales[1] / 100));
                    this.s_w_field_3.setText(String.valueOf(w3 * months_sales[2] / 100));
                    ...
                    this.Error_lable.setText("Total of weight values should equles to 100");
                }
    ...
    private void getCurrentDate() {
        ...
        Forecasting_Controller forecasting_Controller = new Forecasting_Controller();
        ...
        for (int i = 1; i < 4; i++) {
            ...
            // calling database
            months_sales[i - 1] = forecasting_Controller.get_soled_items_for_month(this.producIdCombo.getSelectedItem(), month_start, month_end);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Weighted_moving_average.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Weighted_moving_average().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel s_w_field_1;
    private javax.swing.JLabel s_w_field_2;
    private javax.swing.JLabel s_w_field_3;
