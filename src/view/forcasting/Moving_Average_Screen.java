 ...
 * @author EACMS
 */
public class Moving_Average_Screen extends javax.swing.JFrame {

    /**
     * Creates new form Moving_Average_Screen
     */
    public Moving_Average_Screen() {
        initComponents();
        loadingProductID();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Moving_Average_Screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Moving_Average_Screen().setVisible(true);
            }
        });
    }
